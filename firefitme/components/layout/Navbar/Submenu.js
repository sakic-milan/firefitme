...
const Submenu = () => {
  ...
  return (
    <div className={styles.submenu}>
      <ul className={styles.submenuNav}>{arr.map((element) => el)}</ul>
    </div>
  );
};
